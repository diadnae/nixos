...
in {
  ...
  programs = {
    ...
    git = {
      ...
      userEmail = "diadnae@gmail.com"; # FIXED: set your git email
      userName = "diadnae"; #FIXED: set your git username
      extraConfig = {
    ...
    fish = {
      ...
      interactiveShellInit = ''
        ...
        set -U fish_greeting
        fish_add_path --append /mnt/c/Users/fanfan/scoop/apps/win32yank/current
        fish_add_path --append /mnt/c/Users/fanfan/AppData/Local/Programs/Microsoft\ VS\ Code/bin
      '';
      functions = {
